...
public class QnaVo {
	...
	public String toString() {
		return "QnaVo [qnaSeq=" + qnaSeq + ", qnaReadcnt=" + qnaReadcnt + ", qnaNo=" + qnaNo + ", qnaStep="
				+ qnaStep + ", qnaTitle=" + qnaTitle + ", qnaContent=" + qnaContent
				+ ", qnaFileName=" + qnaFileName + ", qnaFilePath=" + qnaFilePath + ", qnaName=" + qnaName
				+ ", qnaWriter=" + qnaWriter + ", uploadFile=" + 
				", memberSeq=" + memberSeq + "]";
	}
