...
//		}
	...
	// 해당list 내 글 모아보기
		...
		public String boardListMy(@PathVariable Long memberSeq, Model model, Criteria cri,
				HttpSession session) {
		...
		public String diaryEdit(@PathVariable Long diarySeq, @ModelAttribute("DiaryUpdateCommand") DiaryUpdateCommand updateCommand, Model model, HttpSession session) {
...
//			}
		...
		public String diaryEdit(@PathVariable Long diarySeq, @Valid @ModelAttribute("DiaryUpdateCommand") DiaryUpdateCommand updateCommand, BindingResult bindingResult,Model model,
